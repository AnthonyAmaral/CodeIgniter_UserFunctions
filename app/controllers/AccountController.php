...
class AccountController extends BaseController {
   ...
   public function postLogin() {
       ...
       if($validator->fails()) {
           ...
           if($auth) {
               ...
               ->with('global', 'Your email/password is incorrect or your account has not been activated.');
           }
       }      
       return Redirect::route('acount-login')
   ...
   public function postCreate() {
       ...
       if($validator->fails()) {
           ...
           if($user) {
               ...
               return Redirect::route('home')
                       ->with('global', 'Account Created! Please check your email to activate your account.');
           }
       }
   }
   ...
   public function getActivate($code) {
       ...
       if($user->count()) {
           ...
           if($user->save()) {
              return Redirect::route('home')
               ->with('global', 'Account activated! Please sign in.');   
           }
       }
